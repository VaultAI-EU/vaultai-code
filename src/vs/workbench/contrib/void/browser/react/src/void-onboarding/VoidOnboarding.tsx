	...
	useEffect(() => {
		...
		const updateTheme = () => {
			...
			if (divRef.current) {
				...
				divRef.current.style.filter = ""; // Pas de filtre pour garder les couleurs originales
			}
		};
		updateTheme();
			...
			<OnboardingPageShell
				content={
					<div className="flex flex-col items-center gap-8">
						{/* Vault Code logo - smaller and above text */}
						<div className="max-w-[120px] w-full h-[80px] mx-auto flex items-center justify-center">
							{!isLinux && <VoidIcon />}
						</div>

						<div className="text-5xl font-light text-center">
							Welcome to Vault Code
						</div>
