...
const AddButton = ({
	...
	return (
		<button
			disabled={disabled}
			className={`bg-[#0e70c0] px-3 py-1 text-white rounded-sm ${
				!disabled
			...
			>
				...
				<div className="text-sm text-void-fg-3 mb-4">
					{type === "default"
						...
						: isUnrecognizedModel
						? `Model not recognized by Vault Code.`
						: `Vault Code recognizes ${modelName} ("${recognizedModelName}").`}
				</div>
	...
	return (
		<div className="prose-p:my-0 prose-ol:list-decimal prose-p:py-0 prose-ol:my-0 prose-ol:py-0 prose-span:my-0 prose-span:py-0 text-void-fg-3 text-sm list-decimal select-text">
			...
			{sayWeAutoDetect && (
				<div className=" pl-6">
					<ChatMarkdownRender
						string={`Vault Code automatically detects locally running models and enables them.`}
						chatMessageLocation={undefined}
					/>
				</div>
			)}
        ...
        `}
				...
				<main className="flex-1 p-6 select-none">
					<div className="max-w-3xl">
						<h1 className="text-2xl w-full">{`Vault Code Settings`}</h1>
						...
						<div className="flex flex-col gap-12">
							...
							<div className={shouldShowTab("localProviders") ? `` : "hidden"}>
								<ErrorBoundary>
									...
									>{`Vault Code can access any model that you host locally. We automatically detect your local models by default.`}</h3>
							...
							<div className={shouldShowTab("providers") ? `` : "hidden"}>
								<ErrorBoundary>
									...
									<h3
										className={`text-void-fg-3 mb-2`}
									>{`Vault Code can access models from Anthropic, OpenAI, OpenRouter, and more.`}</h3>
								...
								<ErrorBoundary>
									...
									<div className="flex flex-col gap-y-8 my-4">
										...
										<div className="w-full">
											...
											<div className="text-sm italic text-void-fg-3 mt-1">{`Settings that control the visibility of Vault Code suggestions in the code editor.`}</div>
							...
							>
								...
								<div>
									...
									<h4 className="text-void-fg-3 mb-4">{`Transfer Vault Code's settings and chats in and out of Vault Code.`}</h4>
								...
								`}
									...
									<div className="my-4">
										...
										<div className="text-void-fg-3 text-xs mt-1">
											{`When disabled, Vault Code will not include anything in the system message except for content you specified above.`}
										</div>
									</div>
								</div>
							</div>
